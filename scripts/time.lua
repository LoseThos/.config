--	time.lua
--	' ' shows current time on keypress;                     keybind name: "show_time_fn"
--	'T' shows what the time will be at the end of playback; keybind name: "show_end_time_fn"
...
mp.add_key_binding(nil, "show_time", show_time_fn)
mp.add_key_binding(nil, "show_end_time", show_end_time_fn)
